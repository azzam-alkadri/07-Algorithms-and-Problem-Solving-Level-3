// جمع صفوف مصفوفه وتخزينها في مصفوفه ثم طباعتها تم حلها بطريقتين
#include <iostream>
#include <string>
#include <iomanip>
using namespace std;
...
/*void PrintSumRowInMatrix(int arr[3][3], int arrSum[3], short Rows, short
	Cols)
{
	int sum = 0;
...
int main()
{
	...
	PrintMatrix(arr, 3, 3);
	// PrintSumRowInMatrix( arr,arrSum, 3, 3);
